 ...
 */
declare const randomNumber: (min?: number, max?: number, omit?: number) => number;
/**
 ...
 */
declare const newArray: (length: number, mapper: (val: any, i?: number) => any) => any[];
/**
 ...
 */
declare const createNode: (type: string, className?: string, parent?: HTMLElement) => HTMLElement;
/**
...
export { truncateString, randomNumber, newArray, truthy, throttle, createNode, flatten, compress, sanitise, };
