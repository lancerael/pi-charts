 ...
 */
declare const colorFilter: ([r, g, b]: RGBSimple, backgroundContrast?: BackgroundContrast, brightnessBoundary?: number) => boolean;
/**
 ...
 */
declare const randomColor: (backgroundContrast?: BackgroundContrast, brightnessBoundary?: number) => RGBColor;
/**
 ...
 */
declare const addColorsToConfig: (configValues: ValueConfig[], addRGB?: boolean) => ValueConfig[];
export { colorFilter, random256, randomColor, randomPalette, darkerColor, addColorsToConfig, };
