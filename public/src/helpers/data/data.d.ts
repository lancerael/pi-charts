 ...
 */
declare const sliceSampleData: (dataSet: any[], minLength?: number, maxLength?: number) => any[];
/**
 ...
 */
declare const randomData: (length?: number, size?: number, rangeLow?: number, rangeHigh?: number) => ChartTable;
/**
 ...
 */
declare const transformDataKeys: (config: TableConfig | undefined, data: any[]) => TableItem[];
